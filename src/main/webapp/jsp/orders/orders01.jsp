...
s
		...
		<div class="right col-lg-12">
			...
			<div class="right-add">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-danger" data-toggle="modal" data-target="#myAdd">
				<span class="glyphicon glyphicon-plus-sign">&nbsp;</span>添加订单</button>
					...
					<div class="modal-content">
						...
						<form action="${pageContext.request.contextPath}/t_part/addTPart">
							<div class="modal-body">
								<div class="add"><span class="label label-success label-lg">部门名称：</span>&nbsp;&nbsp;
								<select>
								...
								<div class="add"><span class="label label-success label-lg">员工名称：</span>&nbsp;&nbsp;
									<select>
										<option value="">--请选择--</option>
										<option value=""></option>
										<option value=""></option>
								...
								<div class="add"><span class="label label-success label-lg">客户姓名：</span>&nbsp;&nbsp;
									<select>
										<option value="">--请选择--</option>
										<option value=""></option>
										<option value=""></option>
							...
							<div class="modal-footer">
								...
								<input type="submit" class="btn btn-primary" value="添加订单"></input>
							</div>
						</form>
					</div><!-- /.modal-content -->
				</div><!-- /.modal -->
			...
			<div class="right-table col-lg-10">​
                <table class="table table-striped">
                    ...
                    <td><a href="${pageContext.request.contextPath}/deleteOrders/${order.rid}" onclick="del()"><span class="glyphicon glyphicon-share-alt">删除</span></a>
                        <script type="text/javascript">
                        function del(){
                        var msg=confirm("此操作让订单删除，你确定删除此记录吗？");
                        if(msg==true){
                        return true;
                        }else{
                        return false;
