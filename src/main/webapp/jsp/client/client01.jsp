	...
	<div class="container-fluid">
		...
		<div class="right col-lg-12">
			...
			<div class="right-add">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<a href="${pageContext.request.contextPath}/client/queryDelClient">已删除客户</a>
			</div>
			...
			<div class="right-table col-lg-10">​
                <table class="table table-striped">
                    ...
                    <td>${client.cid}</td>
                    <td>${client.cname}</td><td>${client.ctel}</td>
                    ...
                    <td><a href="#" data-target="#modify" data-toggle="modal" ><span class="glyphicon glyphicon-edit">修改</span></a>
                        ...
                        <h4 class="modal-title" id="myModalLabel">修改客户</h4>
                         ...
                         <form action="${pageContext.request.contextPath}/client/updateClient">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" name="cname" type="text" value="" placeholder=" ">
                                </div>
                    ...
                    <td><a href="${pageContext.request.contextPath}/client/deleteClient/${client.cid}" onclick="del()"><span class="glyphicon glyphicon-share-alt">删除</span></a>
                        <script type="text/javascript">
                        function del(){
                        var msg=confirm("此操作回让该客户离职，你确定删除此记录吗？");
                        if(msg==true){
                        return true;
                        }else{
                        return false;
